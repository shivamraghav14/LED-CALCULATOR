...
export default function LEDCalculator() {
  ...
  const calculateValues = () => {
    ...
    const totalWidthPixels = Math.round(convertSize(width) / 500 * pixelDensity);
    const totalHeightPixels = Math.round(convertSize(height) / 500 * pixelDensity);
  ...
  return (
    <div className="p-6 bg-gray-900 text-white rounded-lg shadow-xl max-w-4xl mx-auto">
